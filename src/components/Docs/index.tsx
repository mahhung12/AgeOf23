          ...
          {section.title && (
            <div className="relative -left-0.5 flex items-center gap-1">
              ...
              <span className="relative top-px">
                <IconList icon="chevron" className="h-auto w-4 text-black dark:text-white" />
              </span>
            </div>
          )}
              ...
              <li key={doc.slug}>
                <Link
                  ...
                  className={cx(
                    ...
                    doc.slug === pathname && "!border-blue-200 dark:!border-teal-900 bg-blue-100 dark:bg-teal-950"
                  )}
                >
                  {doc.meta.title}
                </Link>
